...
use astrolend::{errors::AstrolendError, state::astrolend_group::GroupConfig};
use solana_program_test::tokio;

#[tokio::test]
async fn real_oracle_astrolend_account_borrow_success() -> anyhow::Result<()> {
...
#[tokio::test]
async fn real_oracle_pyth_push_astrolend_account_borrow_success() -> anyhow::Result<()> {
    let test_f = TestFixture::new(Some(TestSettings {
        banks: vec![
            TestBankSetting {
                mint: BankMint::Usdc,
