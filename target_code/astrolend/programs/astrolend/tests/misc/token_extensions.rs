...
use astrolend::state::astrolend_group::{
...
#[tokio::test]
async fn astrolend_account_liquidation_success_with_extension(
    ...
    lender_astl_account_f
        .try_liquidate(&borrower_astl_account_f, sol_bank_f, 1, usdc_t22_bank_f)
        .await
        .unwrap();
