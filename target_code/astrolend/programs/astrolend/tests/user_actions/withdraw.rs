...
#[tokio::test]
async fn astrolend_account_withdraw_success(
    deposit_amount: f64,
    withdraw_amount: f64,
    bank_mint: BankMint,
) -> anyhow::Result<()> {
    ...
    let astrolend_account = astrolend_account_f.load().await;
...
#[tokio::test]
async fn astrolend_account_withdraw_all_success(
    deposit_amount: f64,
    bank_mint: BankMint,
) -> anyhow::Result<()> {
    // -------------------------------------------------------------------------
...
#[tokio::test]
async fn astrolend_account_withdraw_failure_withdrawing_too_much(
    deposit_amount: f64,
    withdraw_amount: f64,
    bank_mint: BankMint,
) -> anyhow::Result<()> {
    ...
    let res = astrolend_account_f
        ...
        .await;
    assert!(res.is_err());
    assert_custom_error!(res.unwrap_err(), AstrolendError::OperationWithdrawOnly);
